-- UPDATE SQL: Tambahkan tabel games dan insert data
-- Jalankan ini jika database sudah ada sebelumnya

-- ==========================================
-- 1. BUAT TABEL GAMES (untuk daftar game)
-- ==========================================
...
-- ==========================================
-- 2. INSERT DAFTAR GAME (sesuai proyek)
-- ==========================================
...
-- ==========================================
-- 3. ENABLE RLS & POLICIES UNTUK TABEL GAMES
-- ==========================================
